...
When working with C# code, adhere to the following comprehensive guidelines derived from Microsoft's official documentation, .NET Runtime coding standards, OWASP security guidelines, and C# community best practices.
