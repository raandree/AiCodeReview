...
For comprehensive changelog guidelines, see the dedicated **[changelog.instructions.md](changelog.instructions.md)** file which covers:

- Keep a Changelog 1.1.0 format
- Common Changelog best practices
