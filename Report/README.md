...
If you haven't run a scan yet:

1. **Complete setup**: See [SETUP.md](../SETUP.md) for installation
2. **Place modules**: Add PowerShell modules to `../source/` directory
3. **Run scanner**: Execute `../scanner/Invoke-SecurityScan.ps1 -Path ../source/YourModule -OutputPath ../Report`
4. **Reports appear here**: Generated Markdown reports will be created in this directory
